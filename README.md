...
на 56% ниже «как вчера» и на 8% ниже прогноза «сырая погода + кривая мощности».
...
```bash
python -m pip install -e ".[ml]"          # numpy, pandas, pyarrow, scikit-learn, lightgbm
...
|---|---|---|---|---|---|
| **Ансамбль (итоговая)** | **0.158** | 0.234 | **+8.0%** | **81.5%** | **90.5%** |
...
- Калибровка интервалов работает: у отдельных моделей P10–P90 покрывали 67–72% фактов,
  у откалиброванного ансамбля — 81.5% при цели 80%.
