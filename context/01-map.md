...
| Файл | Что это | Завтра |
|---|---|---|
| `RUN.md` | пошаговый запуск для постороннего: требования, порты, учётки, откуда данные, что работает офлайн, запуск без Docker, типовые сбои | меняется при смене запуска или данных |
...
| `docs/deployability.md` | развёртываемость: три уровня, зачем Kubernetes, что проверено, путь в прод |
